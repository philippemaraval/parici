...
test("Ville entière rank avatars include Astronaute and stay shared by badges and avatar selector", () => {
...
test("Astronaute avatar unlocks from one Ville entière Titi Parisien score", () => {
  ...
  assert.equal(hasReachedVilleRankInAnyMode(pariciProfile, "M"), true);
  assert.equal(hasReachedVilleRank(pariciProfile, "M"), false);
});
